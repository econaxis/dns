pub const DEFAULT_RECORDS: &[&str] = &[
    ...
    "e.ip.henryn.xyz NS ns1.vercel-dns.com",
    "e.ip.henryn.xyz NS ns2.vercel-dns.com",
    "_acme-challenge.g.ip.henryn.xyz TXT RSaT7nPvkqqtXil083-oHjFX8BnCt893h3ooaBeqqQE",
    "g.ip.henryn.xyz A 127.0.0.1",
    // "ip.henryn.xyz NS ns2.henryn.xyz",
    "a.www1.henryn.xyz A 127.0.0.6",
    "aa.ip.henryn.xyz A 127.0.0.1",
    "b.ip.henryn.xyz CNAME c.ip.henryn.xyz",
    "c.ip.henryn.xyz CNAME httpbin.org",
    "ns1.henryn.xyz A 127.0.0.2",
    // "ns2.henryn.xyz A 127.0.0.3",
    "largetext.ip.henryn.xyz CNAME bc.ip.henryn.xyz",
    r#"acme.ip.henryn.xyz TXT AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
    ...
    "bc.ip.henryn.xyz CNAME cb.ip.henryn.xyz",
    "cb.ip.henryn.xyz CNAME c.ip.henryn.xyz",
];
